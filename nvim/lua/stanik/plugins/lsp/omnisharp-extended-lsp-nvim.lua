return {
    {
        ...
        config = function()
            ...
            -- Telescope variants
            vim.api.nvim_set_keymap('n', 'gd', '<cmd>lua require("omnisharp_extended").telescope_lsp_definition()<cr>', opts)
            ...
            vim.api.nvim_set_keymap('n', 'gi', '<cmd>lua require("omnisharp_extended").telescope_lsp_implementations()<cr>', opts)
