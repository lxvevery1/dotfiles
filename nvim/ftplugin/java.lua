...
local workspace_dir = vim.env.HOME .. '/scripts/java_proj/jdtls-workspace/' .. project_name
...
local config = {
  ...
  cmd = {
    ...
    -- TODO Update this to point to the correct jdtls subdirectory for your OS (config_linux, config_mac, config_win, etc) -> Check!
